...
import 'package:peliculas_20233/models/actores_response.dart';
...
class MoviesProvider extends ChangeNotifier{
  ...
  getPopularMovies() async {
    ...
    popularMovies = [...popularMovies, ...popularResponse.results]; //los tres puntos significan para concatnerar con las peliculas 
    notifyListeners();
    
    
    
  }
  getActores(String movie) async{
     var url = Uri.https(_baseUrl, '3/movie/popular', {
      'api_key': _apiKey, 'language': _language, 'page': '1'});
       final response = await http.get(url);
    final Map<String, dynamic> decodeData = json.decode(response.body);
